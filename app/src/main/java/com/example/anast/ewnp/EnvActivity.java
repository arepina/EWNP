...
public class EnvActivity extends AppCompatActivity implements SwipeListView.SwipeListViewCallback {

    private WordOperationsEnv studentDBoperation;
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public void deleteItem(int pos) {
            m_List.remove(pos);
            WordOperationsEnv.database.delete(DataBaseWrapperEnv.WORDS, DataBaseWrapperEnv.WORD_ID + " = " + pos, null);
            delete_pos = invalid;
            notifyDataSetChanged();
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(EnvActivity.this).inflate(R.layout.item, null);
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton home = (ImageButton)findViewById(R.id.homeenv);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
                finishActivity(27);
                Intent intent = new Intent(EnvActivity.this, NewWordToDictionary.class);
        ...
        studentDBoperation = new WordOperationsEnv(this);
        studentDBoperation.open();
        values = studentDBoperation.getAllStudents();
        list = (ListView) findViewById(R.id.objectslistenv);
    ...
    public void addUser(View view) {
        ...
        EditText rus = (EditText) findViewById(R.id.editruswordenv);
        EditText eng = (EditText) findViewById(R.id.editengwordenv);
        if(!Check.rus(rus.getText().toString().toLowerCase()) || !Check.eng(eng.getText().toString().toLowerCase()))
        {
            ...
            WordEnv stud = studentDBoperation.addStudent(rus.getText().toString(), eng.getText().toString(), m_Adapter.getCount());
            values = studentDBoperation.getAllStudents();
            m_Adapter = new MyAdapter();
            try {
                if (values.size() != 0) {
